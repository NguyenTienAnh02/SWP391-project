...
const AddRequest = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:8080/api/skill/mentor/${mentorID}`, {
          ...
          <Row>
            <Col md={12}>
              <Form onSubmit={handleSubmit}>
                ...
                <Row>
                  <Button style={{ margin: 15 }} onClick={handleBack}>
                    Choose class
                  </Button>
                </Row>
                <Row>
                  ...
                  <Form.Group className="col-md-6">
                    ...
                    {skill.slice(0, Math.ceil(skill.length / 2)).map((s) => (
                      <div key={s.skillID}>
                        ...
                        />
                        <label htmlFor={s.skillID}>&emsp;{s.skillName}</label>
                        <br />
                      </div>
                    ))}
                  </Form.Group>
                ...
                <Row>
                  <Col style={{ textAlign: "center", padding: "30px" }}>
                    ...
                    |
                    <Link to={"/requestuser/" + id} className="btn btn-danger">
                      Back to List
                    </Link>
                  </Col>
                </Row>
